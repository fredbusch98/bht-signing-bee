...
<img src="resources/results/asl-alphabet.png" alt="Konfusionsmatrix" width="600" height="600">
...
#### 4. **Zusammenfassung des Modells:**
   ...
   - **Gesamtzahl der Parameter**:
     ...
     - Für `fc1`: $(63 * 128) + 128 = 8128$
     - Für `fc2`: $(128 * 128) + 128 = 16512$
     - Für `fc3`: $(128 * 24) + 24 = 3104$
