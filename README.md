...
In der Studie von **Byeongkeun Kang et al. (2015)** wird ein System vorgestellt, das mithilfe von Convolutional Neural Networks (CNNs) und Tiefenbildern das ASL-Fingerspelling-Alphabet in Echtzeit erkennt. Durch die Verwendung von Depth Maps können sie die Position und Tiefe der Hand präzise erfassen, was das System robuster gegenüber variierenden Lichtverhältnissen und Hautfarben macht. Das Resultat ist eine beeindruckende Erkennungsgenauigkeit von 99,99% bei bekannten Nutzern und bis zu 85,49% bei neuen Nutzern. Besonders interessant ist, dass sie durch das Hinzufügen von Daten verschiedener Nutzer die Leistung des Systems weiter steigern konnten, was die Bedeutung eines vielfältigen Trainingsdatensatzes unterstreicht.

Im Vergleich dazu nutzen wir in unserer Anwendung MediaPipe Hands, wie es im Paper von **Fan Zhang et al. (2020)** beschrieben wird. Anstatt auf Tiefensensoren zu setzen, verwenden wir herkömmliche Webcams, um Handgesten zu erkennen. MediaPipe verfolgt dabei 21 Hand-Landmarks in Echtzeit, was eine präzise Verfolgung der Handbewegungen ermöglicht, ohne auf spezielle Hardware angewiesen zu sein. Während Kang und sein Team auf Tiefeninformationen setzen, zeigt unser Ansatz, dass auch mit RGB-Bildern und der richtigen Software eine hohe Genauigkeit erreicht werden kann.

Ein weiterer Unterschied liegt in der Datenverarbeitung. Während Kang et al. vorverarbeitete Tiefenbilder nutzen und CNNs einsetzen, haben wir uns für die Verarbeitung von Landmark-Daten entschieden und verwenden ein Multilayer Perceptron (MLP). Da unsere Daten keine räumlichen Beziehungen wie Bilder haben, sondern numerische Features sind, ist das MLP besser für unsere Zwecke geeignet. Dies führt zu schnelleren Trainingszeiten und besseren Ergebnissen in unserer spezifischen Anwendung.
